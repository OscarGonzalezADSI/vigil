    ...
    <div style="background-color:#00000050; margin-top:0px; padding:10px">
        ...
        <table class="table table-hover table-condensed table-responsive" style="margin: 0px 0px 0px 0px">
            <tbody>
                ...
                <tr>
                    <td>
                        <a class="btn btn-primary" href="http://localhost/web/OurCRUD/proyectos/cursos/certificadovig/certficado/index.php?nombre=<?php echo $fila['personaNombre']; ?>&apellido=<?php echo $fila['personaApellido']; ?>&cedula=<?php echo $fila['personaCedula']; ?>&curso=<?php echo $fila['cursoNombre']; ?>&ciudad=cucuta&fecha=02-04-2020">Descargar</a>
                    </td>
